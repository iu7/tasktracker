...
perl run.pl --mem 384 --fwd=hostfwd=tcp:127.0.0.1:5004-10.0.0.7:8080 \
	    --mac1=52:54:00:00:aa:16 \
	    --mac2=52:54:00:00:aa:18 \
	    --switch=$PATH_TO_SWITCH projects.cow # 192.168.0.7
